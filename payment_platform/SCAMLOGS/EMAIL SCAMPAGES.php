                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="hero__text">
                                ...
                                <h2>Welcome !!!!!! <br /> EMAIL SCAMPAGES</h2>
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2 col-12">
                        <div class="section-header text-center">
                            <h3 class="section-title">Email Scampage</h3>
                            ...
                            <table class="table show-table table-borderless">
                                ...
                                <tr>
                                      ...
                                      <td class="show-date">
                                        ...
                                        <span class="day">General Scampage</span>
                                    </td>
                                    
                                    <td class="show-hall">
                                        <span class="hall-name">Email & Password</span>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="show-date">
                                      <span class="date"></span>
                                      <span class="day">Office 365 Scampage</span>
                                  </td>
                              ...
                              <tr>
                                    ...
                                    <td class="show-date">
                                      <span class="date"></span>
                                      <span class="day">Dropbox Scampage</span>
                                  </td>
                              ...
                              <tr>
                                    ...
                                    <td class="show-date">
                                      <span class="date"></span>
                                      <span class="day">Webmail Scampage</span>
                                  </td>
