...
<body>
                           ...
                           <li class="active"><a href="./index.php">Home</a></li>
                            ...
                            <li><a href="#">Support</a>
                                <ul class="dropdown">
                                    <li><a href="./FAQ.php">FAQ</a></li>
                                    <li><a href="./TICKETS.php">TICKETS</a></li>
                                    <li><a href="./CHANGE PASWORD.php">CHANGE PASWORD</a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="hero__text">
                                ...
                                <h2>Welcome !!!!!! <br /> TOP UP </h2>
                               
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="hero__img">
                                <img src="img/hero/hero-right1.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
   ...
   <!-- top up section begin-->
<div class="row"></div>
    <div class="col-md-12">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-x1-12">
                <div class="card shadow-lg">
                <div class="card-header card-header-divider text-center pt-4">
                    <img src="https://apirone.com/static/promo/bitcoin_logo_vector.svg" class="img-fluid" style="max-height: 42;" width="205" alt>
                         <br>
                    </div>
                    <div class="card-body px-0">
                     <h2 class="text-center">
                        <strong>3JoXvTzWs1FGXbJtoaMQLEXw5vnsnDhS6K</strong>
                                    </h2>
                       
                        <img src="assets/images/bitcoin.png" alt="myadress" class="center" id="bit" style="width: 250px;"> 
                        <p class="text-muted text-center">
                           "Payment should be done through this wallet above."
                              <br>
                               "payment will be credited after 1 confirmation."
                               <br>
                        </p>
                        
                        <h4>Note: 100 USD Minium funding for your first funding</h4>
                           </div>
                            </div>
                             </div>
                               </div>
