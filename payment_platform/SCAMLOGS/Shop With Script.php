                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="hero__text">
                                ...
                                <h2>Welcome !!!!!! <br /> SHOP WITH SCRIPT </h2>
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2 col-12">
                        <div class="section-header text-center">
                            <h3 class="section-title">Shop with script</h3>
                            ...
                            <table class="table show-table table-borderless">
                                ...
                                <tr>
                                      ...
                                      <td class="show-date">
                                        ...
                                        <span class="day">Shop with script</span>
                                    </td>
                                    
                                    <td class="show-hall">
                                        <span class="hall-name">3 year old account</span>
                                    </td>
